...
class CharacterAI:
    def __init__(self, character_id):
        ...
        # Исправлено: все промпты написаны без опечаток, чтобы Groq строго ставил тег в конце
        self.prompts = {
            ...
            "monica": (
                ...
                "ОБЯЗАТЕЛЬНОЕ ПРАВИЛО: В самый конец своего сообщения допиши строго тег: [SEND_PHOTO: gorgeous woman]"
            )
        }
    ...
    def generate_image_url(self, prompt: str) -> str:
        # Ссылки на реальные качественные фотографии моделей из Telegra.ph (одобрено серверами Telegram)
        database = {
            "sophia": [
                "https://telegra.ph",
                "https://telegra.ph"
        ...
        images = database.get(self.character_id, database["monica"])
